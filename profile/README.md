...
## 🙋‍♀️ Wat is Open Verwerkingen

## 👩‍💻 Useful resources
- Demo omgeving: [OpenVerwerkingen.nl](https://openverwerkingen.nl)

## Datamodelen
Het datamodel van open catalogi is gebaseerd op de logging en verwerkingsstandaard van de VNG/

Lees meer
-	[Verwerkingen](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/OpenVerwerkingen/verwerkingenregister/master/oas.yaml&nocors)
-	[VerwerkingsActiviteiten](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/OpenVerwerkingen/loggingregister/master/oas.yaml&nocors)
